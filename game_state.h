...
public:
    ...
    std::optional<ServerMessage::AcceptedPlayer> handle_client_join_message(ClientMessage::Join &msg);

//private:
//    ServerMessage::server_message_optional_variant generate_server_message();
//
//
//    ServerMessage::server_message_optional_variant handle_join(ClientMessage::Join &msg, player_id_t player_id);
//    ServerMessage::server_message_optional_variant handle_place_bomb(player_id_t player_id);
//    ServerMessage::server_message_optional_variant handle_place_block(player_id_t player_id);
//    ServerMessage::server_message_optional_variant handle_move(ClientMessage::Move &msg, player_id_t player_id);
